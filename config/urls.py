...
from core.api_main import MeView, DashboardView, ValidatePersonFieldView, TeacherMySubjectsView
...
from core.api_subjects import SubjectsView, SubjectDetailView, SubjectEmployeesView, SubjectEmployeeDetailView, SubjectDeleteRequestView
...
urlpatterns = [
    ...
    path('api/teacher/my-subjects/', TeacherMySubjectsView.as_view()),
    ...
    path('api/subjects/<int:pk>/delete-request/', SubjectDeleteRequestView.as_view()),
    ...
    path('api/delete-requests/<int:pk>/cancel/', DeleteRequestCancelView.as_view()),
