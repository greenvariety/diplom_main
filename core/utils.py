...
_EMAIL_SUBJECTS = {
    ...
    'change_email': 'Код подтверждения смены email - АИСК',
    'delete_account': 'Код подтверждения удаления аккаунта - АИСК',
}
_EMAIL_ACTIONS = {
    'register': 'подтверждения регистрации',
    'recover': 'восстановления пароля',
    'delete_org': 'подтверждения удаления организации',
    'change_email': 'подтверждения смены email',
    'delete_account': 'подтверждения удаления аккаунта',
}
