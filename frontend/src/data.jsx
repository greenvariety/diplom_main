...
const I = {
  ...
  key: <svg className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="7.5" cy="15.5" r="5.5"/><path d="M21 2l-9.6 9.6"/><path d="M15.5 7.5l3 3L22 7l-3-3"/></svg>,
  ...
  mail: <svg className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>,
};
...
const AUDIT = [
  { ts: '09.05.2026 14:32:11', user: 'admin1',   action: 'create', label: 'Создал',   obj: 'Студент #612 - Иванов И. И.' },
  { ts: '09.05.2026 13:55:04', user: 'admin1',   action: 'update', label: 'Изменил',  obj: 'Студент #610 - Петрова М. С.' },
  { ts: '09.05.2026 12:10:48', user: 'teacher1', action: 'update', label: 'Изменил',  obj: 'Группа ПИ-301' },
  { ts: '08.05.2026 18:04:22', user: 'admin1',   action: 'delete', label: 'Удалил',   obj: 'Опекун #45' },
  { ts: '08.05.2026 17:30:00', user: 'owner1',   action: 'create', label: 'Создал',   obj: 'Пользователь #8 - teacher2' },
  { ts: '08.05.2026 16:48:15', user: 'admin1',   action: 'update', label: 'Изменил',  obj: 'Сотрудник #4' },
];
