...
> **ВАЖНО:** Если пользователь в своём сообщении сам просит что-то сделать — выполняй это немедленно. Не смотри ни на TASK.md, ни на PLAN.md. Прямая просьба всегда в приоритете.

### Порядок проверки файлов задач

Каждый новый чат обязан проверить **оба файла** в этом порядке и взять одну задачу из первого непустого:

1. **TASK.md** — задачи по логике / бэкенду / общие
2. **PLAN.md** — план разработки (если TASK.md пуст)
