...
WORDLIST = [
    ...
    "discover", "disease", "dismiss", "disorder", "display", "distance", "divert", "divide",
    ...
    "game", "gap", "garbage", "garden", "garlic", "garment", "gas", "gasp",
    "gate", "gather", "gauge", "gaze", "general", "genius", "genre", "gentle",
    "genuine", "gesture", "ghost", "gift", "giggle", "ginger", "giraffe", "girl",
    ...
    "hip", "hire", "history", "hobby", "hockey", "hold", "hole", "hollow",
    ...
    "loop", "lottery", "loud", "loyal", "lucky", "luggage", "lunar", "lunch",
    "luxury", "mad", "magic", "magnet", "maid", "main", "mammal", "mango",
    "mansion", "manual", "maple", "marble", "march", "margin", "marine", "market",
    "marriage", "mask", "master", "match", "material", "math", "matter", "maximum",
    "maze", "meadow", "mean", "medal", "media", "melody", "melt", "member",
    "memory", "mention", "menu", "mercy", "mesh", "message", "metal", "method",
    "middle", "midnight", "milk", "million", "mimic", "mind", "minimum", "minor",
    "minute", "miracle", "miss", "mixed", "mixture", "mobile", "model", "modify",
    ...
    "narrow", "nasty", "natural", "nature", "near", "neck", "need", "negative",
    ...
    "ocean", "october", "odor", "offer", "office", "often", "oil", "okay",
    ...
    "sauce", "sausage", "save", "scale", "scan", "scatter", "scene", "scheme",
    "school", "science", "scissors", "scorpion", "scout", "screen", "script", "scrub",
    "search", "season", "seat", "second", "secret", "section", "security", "seed",
    "seek", "segment", "select", "sell", "seminar", "senior", "sense", "series",
    ...
    "shrimp", "shrug", "shuffle", "sick", "side", "siege", "sight", "sign",
    ...
    "unfair", "unfold", "unhappy", "uniform", "unique", "universe", "unknown", "unlock",
    "until", "unusual", "unveil", "update", "upgrade", "uphold", "upon", "upper",
    "upset", "urban", "useful", "useless", "usual", "utility", "vacant", "vacuum",
    ...
    "walnut", "want", "warfare", "warm", "warrior", "waste", "water", "wave",
    "way", "wealth", "weapon", "wear", "weasel", "weather", "web", "wedding",
    "weekend", "weird", "welcome", "well", "west", "wet", "whale", "wheat",
    "wheel", "when", "where", "whip", "whisper", "wide", "width", "wife",
    "wild", "will", "win", "window", "wine", "wing", "wink", "winner",
    "winter", "wire", "wisdom", "wise", "wish", "witness", "wolf", "woman",
    "wonder", "wood", "wool", "word", "world", "worry", "worth", "wrap",
...
def generate_seed_phrase():
    words = random.choices(WORDLIST, k=12)
    return ' '.join(words)
...
def verify_seed_phrase(phrase: str, stored_hash: str) -> bool:
    return hash_seed_phrase(phrase) == stored_hash
...
def get_institution_from_session_safe(user):
    """Returns institution without raising exceptions (for log_action)."""
    try:
        if user.is_owner:
            return None
...
def superadmin_required(view_func):
    """Alias for owner_required (backward compatibility)."""
